...
<body>
    ...
    if(isset($_GET['id'])){
        ...
        $autor = $consulta->fetch_assoc();
        }
    
    ?>

    <div class="container" id="menor">
        <form method="post" autocomplete="on" action = "editar-autor.php?id=<?php echo $_GET['id']?>">



            <!--Título-->
            <div class="col-12 mb-2">
                <h1 id="title"><b> Editar Autor </b></h1>
                <hr>
            </div>
            ...
            <div class="row justify-content-md-center ">
                <div class="form-group col-auto col-6 col-lg-4 col-xl-3">
                    <label style="margin: auto;" for="txtAutor">Autor:</label>
                    <input type="text" name="txtAutor" id="txtAutor" placeholder="Nome do autor:" class="form-control" autofocus required value="<?php echo $autor['nome'] ?>">
                </div>
            </div>
            ...
            <div class="row justify-content-md-center">
                <div style="align-items: center;">
                    ...
                    <a href="consultar-autor.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
                </div>
            </div>
