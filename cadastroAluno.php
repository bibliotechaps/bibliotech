    ...
    <form name="CadastroAluno" action="insert-aluno.php" method="POST" style="padding: 20px; align-content: center; ">
      ...
      <div class="row justify-content-around">
        ...
        <div class="form-group col-auto w-25">
          ...
          <input type="number" id="RAnumberaluno" class="form-control" placeholder="RA do Aluno" required="">
        </div>
        ...
        <div class="form-group col-auto w-25">
          ...
          <input type="text" id="CEPnumberaluno" class="form-control" placeholder="CEP do Aluno" required="">
        </div>
        ...
        <div class="form-group col-auto w-25">
          <label for="senhatxtaluno">Senha:</label> <br>
          <input type="text" id="senhatxtaluno" class="form-control" placeholder="Senha do Aluno" required="">
        </div>
