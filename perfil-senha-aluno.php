...
<php lang="en">
    ...
    <head>
        ...
        <script>
            function confirmarModificacao() {
                if (window.confirm("Deseja realmente editar a senha do(a) aluno(a)?")) {
        ...
        <div class="container" id="menor">
            <form action="" class="">
                ...
                <div class="row justify-content-center w-100">
                    ...
                    <div class="row justify-content-center w-100">
                        ...
                        <div class="form-group ">
                            <label style="margin: auto;" for="senhaAtual">Digite a senha do aluno:</label><br>
                ...
                <div class="row justify-content-center container" style="align-items: center;">
                    <div class="mr-2">
                        <a href="#" onclick="confirmarModificacao('')"><input class="btn btn-success" type="submit" onclick="validatePassword()" value="Atualizar"><a>
                    </div>
                    <div>
                        <a href="perfil-editable-aluno.php?id=<?php echo $_GET["id"] ?>"><button id="cancelar" type="button" class="btn btn-danger">Cancelar</button></a>
                    </div>
